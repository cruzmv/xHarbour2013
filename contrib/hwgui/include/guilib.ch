...
#xcommand INIT WINDOW <oWnd> CHILD          ;
   ...
   #xcommand INIT DIALOG <oDlg>                ;
             ...
             <oDlg> := HDialog():New( Iif(<.res.>,WND_DLG_RESOURCE,WND_DLG_NORESOURCE), ;
                ...
                iif(!empty(<ico>),<ico>, ),<.lExitOnEnter.>,<nHelpId>,<Resid>,<.lExitOnEsc.>,<clr>,<bRefresh>,<.lnoClosable.>)
#else
   #xcommand INIT DIALOG <oDlg>                ;
                [<res: FROM RESOURCE> <Resid> ];
                [ TITLE <cTitle> ]             ;
...
#xcommand INSERT NODE [ <oNode> CAPTION ] <cTitle> ;
             ...
             [ <lCheck: CHECKED>]                  ;
          => ;
          [<oNode> := ] <oTree>:AddNode( <cTitle>,<oPrev>,<oNext>,<bClick>, <aBmp>, <bDClick>, <.lCheck.>, <bAction> )
...
#xcommand SYG_INSERT NODE [ <oNode> CAPTION ] <cTitle> ;
             ...
             [ <lCheck: CHECKED>]                  ;
          => ;
          [<oNode> := ] <oTree>:SYG_AddNode( <cTitle>,<oPrev>,<oNext>,<bClick>, <aBmp>, <bDClick>, <.lCheck.>, <bAction> )
...
/* SAY ... GET system     */
   ...
   #xcommand @ <x>,<y> GET [ <oEdit> VAR ]  <vari>  ;
             ...
             [<oEdit> := ] HEdit():New( <oWnd>,<nId>,<vari>,               ;
                ...
                <.lnoborder.>,<nMaxLength>,<.lPassword.>,<bKeyDown>,<bChange>,<bOther>,<.lnopaste.>,<cCueText>);;
             [ <oEdit>:name := <(oEdit)> ]
#else
   #xcommand @ <x>,<y> GET [ <oEdit> VAR ]  <vari>  ;
                [ OF <oWnd> ]              ;
