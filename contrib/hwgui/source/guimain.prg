...
FUNCTION ALERT(_cMSG)
HWG_MSGINFO(_cMSG,'Aviso do Sistema')
RETURN(.T.)

FUNCTION MSGINFO(_cMSG,_cTIT)
IF _cTIT=NIL
...
FUNCTION MsgNoYes(_cMSG,_cTIT)
IF _cTIT=NIL
   _cTIT:='Aviso do Sistema'
ENDIF
RETURN(HWG_MsgNoYes(_cMSG,_cTIT))

FUNCTION MsgYesNo(_cMSG,_cTIT)
IF _cTIT=NIL
   _cTIT:='Aviso do Sistema'
ENDIF
RETURN(HWG_MsgYesNo(_cMSG,_cTIT))

FUNCTION MSGRETRYCANCEL(_cMSG,_cTIT)
LOCAL nRET:=0
IF _cTIT=NIL
   _cTIT:='Aviso do Sistema'
ENDIF
...
FUNCTION MSGOKCANCEL(_cMSG,_cTIT)
IF _cTIT=NIL
   _cTIT:='Aviso do Sistema'
ENDIF
RETURN(HWG_MSGOKCANCEL(_cMSG,_cTIT))

FUNCTION MSGYESNOCANCEL(_cMSG,_cTIT)
IF _cTIT=NIL
   _cTIT:='Aviso do Sistema'
ENDIF
RETURN(HWG_MSGYESNOCANCEL(_cMSG,_cTIT))

FUNCTION MSGEXCLAMATION(_cMSG,_cTIT)
IF _cTIT=NIL
   _cTIT:='Aviso do Sistema'
ENDIF
RETURN(HWG_MSGEXCLAMATION(_cMSG,_cTIT))

FUNCTION SELECTFILE(aP1,aP2)
Local cRET:=''
cRET := HWG_SelectFile( aP1, aP2 )
RETURN(cRET)

FUNCTION SELECTFOLDER(cTITDIALOG)
Local cRET:='', cSALVA_PATH := CAMINHO_EXE()

cRET:=HWG_SELECTFOLDER(cTITDIALOG)
