...
Function Main( cDSN )
   ...
   ? "Creating table 1    :", dbCreate( cTableName1, aStruct1, "SQLRDD" )
   ? "Creating table 2    :", dbCreate( cTableName2, aStruct2, "SQLRDD" )

   USE (cTableName1) SHARED VIA "SQLRDD" NEW
   ? "Alias               :", alias(), select()
   USE (cTableName2) SHARED VIA "SQLRDD" NEW
   ? "Alias               :", alias(), select()
   ...
   ordcreate( "TEST_TABLE2_IND02", "TAG_X", "substr(NAME,5)" )
   ordcreate( "TEST_TABLE2_IND02", "TAG_Y", "substr(NAME,15)" )
